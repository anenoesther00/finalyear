  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <h1 class="my-4">Rentals available</h1>
        <div class="list-group">
          <a href="#" class="list-group-item">Rooms</a>
          <a href="#" class="list-group-item">Apartments</a>
          <a href="#" class="list-group-item">Bungalows</a>
          <a href="#" class="list-group-item">Masion</a>
        </div>
